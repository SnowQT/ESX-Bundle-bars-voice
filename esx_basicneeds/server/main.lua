...
ESX.RegisterUsableItem('bread', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'shit', -80000)
...
ESX.RegisterUsableItem('chocolate', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'shit', -50000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('cupcake', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 200000)
	TriggerClientEvent('esx_status:add', source, 'shit', -30000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('water', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'pee', 100000)
...
ESX.RegisterUsableItem('wine', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'pee', -80000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
...
ESX.RegisterUsableItem('beer', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'thirst', 200000)
	TriggerClientEvent('esx_status:add', source, 'pee', -30000)
	TriggerClientEvent('esx_basicneeds:onDrink', source)
...
ESX.RegisterUsableItem('saucisson', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'hunger', 600000)
	TriggerClientEvent('esx_status:add', source, 'shit', -40000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
...
ESX.RegisterUsableItem('grapperaisin', function(source)
	...
	TriggerClientEvent('esx_status:add', source, 'pee', -500)
	TriggerClientEvent('esx_basicneeds:onEat', source)
...
local xPlayer = ESX.GetPlayerFromId(source)
	...
	TriggerClientEvent('esx_status:add', source, 'shit', -100000)
	TriggerClientEvent('esx_basicneeds:onEat', source)
